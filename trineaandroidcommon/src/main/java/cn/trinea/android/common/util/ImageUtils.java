...
public class ImageUtils {
     ...
     * @return
     * @see ImageUtils#getInputStreamFromUrl(String, int, Map<String, String>)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see ImageUtils#getDrawableFromUrl(String, int, Map<String, String>)
     */
     ...
     * @param readTimeOut
     * @return
     * @see ImageUtils#getBitmapFromUrl(String, int, Map<String, String>)
     */
